                ...
                <div class="list-group-item">
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            ...
                            <br/>
                            <strong>Tel: <a href="tel:<?php echo $site['sSitePhone'] ?>"><?php echo $site['sSitePhone'] ?></a></strong>
                        </div>
                        <div style="display:none;" class="col-lg-2 text-right">
                            <?php
						...
						<a class="btn btn-primary rentBtn" href="/step_two?location=<?php echo $site['sLocationCode']; ?>">Continue</a>
                    </div>
                </div>
            </div>
        <?php } ?>
